"""
Django settings for azshserver project.
...
WSGI_APPLICATION = 'azshserver.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get('AZSH_EMAIL_KULLANICI')
EMAIL_HOST_PASSWORD = os.environ.get('AZSH_EMAIL_SIFRE')
DEFAULT_FROM_EMAIL = os.environ.get('AZSH_EMAIL_KULLANICI')

# django-ratelimit tek worker ile calisiyor, shared cache uyarisi bilinçli olarak kapatildi
